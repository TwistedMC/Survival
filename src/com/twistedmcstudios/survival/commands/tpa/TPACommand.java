...
public class TPACommand extends CoreCommand {
    ...
    public TPACommand() {
        super("tpa", new String[] {}, 1, Rank.PLAYER, "<player>", false, false);
    }
    ...
    public void execute() {
        ...
        tpQueue.TELEPORT_REQUESTS.put(target.getUniqueId(), new TeleportRequest(getAccount().getUUID(), false));
        target.sendMessage(getAccount().getManager().getRankName() + c.yellow + " has sent a teleportation request to you! To accept, type " + c.gold + "/tpaccept" + c.yellow + ". To deny, type " + c.gold + "/tpdeny" + c.yellow + ".");
